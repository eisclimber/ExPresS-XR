...
namespace UnityEngine.XR.Interaction.Toolkit.Attachment
{
    ...
    public class ScalingInteractionAttachController : MonoBehaviour, IInteractionAttachController
    {
        /// <summary>
        ...
        public enum ManipulationYAxisMode
        {
            ...
            /// <summary>
            /// Scales the anchor over time (requires ExPresSXRInteractables).
            /// </summary>
            Scale,

            /// <summary>
            /// Scales the anchor over time with translation fallback if not a ExPresSXRInteractable.
            /// </summary>
            ScaleTranslate,
        }
        ...
        protected void DoPositionUpdate(float deltaTime)
        {
            ...
            bool inputValid = m_ManipulationInput.TryReadValue(out var input);
