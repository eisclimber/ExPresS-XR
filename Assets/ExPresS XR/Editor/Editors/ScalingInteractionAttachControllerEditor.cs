...
namespace UnityEditor.XR.Interaction.Toolkit.Attachment
{
    ...
    /// </summary>
    [CustomEditor(typeof(ScalingInteractionAttachController), true), CanEditMultipleObjects]
    public class InteractionAttachControllerEditor : BaseInteractionEditor
    {
        ...
        /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="InteractionAttachController.manipulationScaleSpeed"/>.</summary>
        protected SerializedProperty m_ManipulationScaleSpeed;
        ...
        protected static class Contents
        {
            ...
            /// <summary><see cref="GUIContent"/> for <see cref="InteractionAttachController.manipulationScaleSpeed"/>.</summary>
            public static readonly GUIContent manipulationScaleSpeed = EditorGUIUtility.TrTextContent("Scale Speed", "Speed at which the anchor is scaled when using manipulation input.");
        ...
        protected void OnEnable()
        {
            ...
            m_ManipulationScaleSpeed = serializedObject.FindProperty("m_ManipulationScaleSpeed");
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                if (m_UseManipulationInput.boolValue)
                {
                    using (new EditorGUI.IndentLevelScope())
                    {
                        ...
                        if ((ScalingInteractionAttachController.ManipulationYAxisMode)m_ManipulationYAxisMode.intValue == ScalingInteractionAttachController.ManipulationYAxisMode.Translate
                                || (ScalingInteractionAttachController.ManipulationYAxisMode)m_ManipulationYAxisMode.intValue == ScalingInteractionAttachController.ManipulationYAxisMode.ScaleTranslate)
                        {
                            EditorGUILayout.PropertyField(m_ManipulationTranslateSpeed, Contents.manipulationTranslateSpeed);
                        }

                        if ((ScalingInteractionAttachController.ManipulationYAxisMode)m_ManipulationYAxisMode.intValue == ScalingInteractionAttachController.ManipulationYAxisMode.Scale
                                || (ScalingInteractionAttachController.ManipulationYAxisMode)m_ManipulationYAxisMode.intValue == ScalingInteractionAttachController.ManipulationYAxisMode.ScaleTranslate)
                        {
                            EditorGUILayout.PropertyField(m_ManipulationScaleSpeed, Contents.manipulationScaleSpeed);
                        }
                        ...
                        if ((InteractionAttachController.ManipulationXAxisMode)m_ManipulationXAxisMode.intValue == InteractionAttachController.ManipulationXAxisMode.HorizontalRotation ||
                            (ScalingInteractionAttachController.ManipulationYAxisMode)m_ManipulationYAxisMode.intValue == ScalingInteractionAttachController.ManipulationYAxisMode.VerticalRotation)
                        {
